    ...
    <div className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Access Your Workouts Anywhere</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Personalized Access Codes</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Cross-Device Compatibility</h3>
                <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Complete Workout Details</h3>
                <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Level-Based Progression</h3>
                <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="grid grid-cols-2 gap-6">
              ...
              <Card className="bg-white dark:bg-gray-800 shadow-lg">
                <CardContent className="p-6">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-gray-500">Full-Body Strength Program</p>
                  </div>
                  ...
                  <div className="mt-4 text-center">
                    <p className="font-mono bg-gray-100 dark:bg-gray-700 py-1 px-2 rounded text-sm inline-block">
            ...
            <Card className="bg-white dark:bg-gray-800 shadow-md">
              <CardContent className="p-4">
                <div className="text-center mb-2">
                  <h3 className="text-sm font-semibold">Beginner</h3>
                </div>
                <div className="flex justify-center">
                  <QRCodeDisplay 
                ...
                <div className="mt-2 text-center">
                  <p className="font-mono bg-gray-100 dark:bg-gray-700 py-1 px-2 rounded text-xs inline-block">
            ...
            <Card className="bg-white dark:bg-gray-800 shadow-md">
              <CardContent className="p-4">
                <div className="text-center mb-2">
                  <h3 className="text-sm font-semibold">VIP</h3>
                </div>
                <div className="flex justify-center">
                  <QRCodeDisplay 
