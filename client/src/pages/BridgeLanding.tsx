      ...
      <section className="bridge-hero min-h-screen flex items-center pt-20 relative bg-black">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-[140px] font-bold leading-none tracking-tighter">
              <span className="block">NOT Y<span className="inline-block bg-white text-white h-[55px] md:h-[120px] px-3 mx-1 rounded-full"></span>UR</span>
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center">
            <p className="text-white text-sm font-bold mb-3 uppercase tracking-wider">AI-POWERED FITNESS</p>
            <h2 className="text-5xl md:text-8xl font-bold text-white uppercase tracking-tight mb-6">
              FUTURE OF FITNESS
            </h2>
