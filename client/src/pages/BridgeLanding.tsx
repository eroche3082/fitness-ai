      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center">
            ...
            <div className="w-24 h-[3px] bg-green-500 mx-auto mb-10"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bridge-card text-center p-8 hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center text-green-500 mx-auto mb-6 border-2 border-green-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-black rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl border border-gray-700">
              <div className="p-8">
                ...
                <Link to="/signup">
                  <Button className="w-full py-3 bg-black hover:bg-gray-900 text-white">
                    Get Started Free
                  </Button>
                </Link>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              {/* Note: Social media icons commented out until actual accounts are available */}
              {/* <div className="flex space-x-4">
                <a href="https://facebook.com/fitnessai" className="w-10 h-10 border border-green-500 flex items-center justify-center hover:bg-green-500 hover:text-black transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path></svg>
                </a>
                <a href="https://instagram.com/fitnessai" className="w-10 h-10 border border-green-500 flex items-center justify-center hover:bg-green-500 hover:text-black transition-colors">
                ...
                <a href="https://twitter.com/fitnessai" className="w-10 h-10 border border-green-500 flex items-center justify-center hover:bg-green-500 hover:text-black transition-colors">
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm">© 2025 Fitness AI. <span className="text-green-500">Leading the fitness revolution with AI.</span> All rights reserved.</p>
